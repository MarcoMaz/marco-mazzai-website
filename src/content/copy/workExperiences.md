...
workExperiencesItems:
  ...
  - workPlace: "FitXr"
    ...
    tasks:
      - Collaborated with Design to enhance the design system, focusing on typography and foundational design tokens
      - Improved homepage accessibility and leveraged Storybook for component development, documentation, and testing
  ...
  - workPlace: "Media X Change"
    ...
    location: Berlin, Germany
    tasks:
      - Implemented over 700 micro-sites from existing wireframes using React and TypeScript
      - Led QA for over 20 clients, ensuring top-quality micro-site deliveries
---
